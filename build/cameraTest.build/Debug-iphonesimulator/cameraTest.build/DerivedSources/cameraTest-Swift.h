...
SWIFT_MODULE_NAMESPACE_PUSH("cameraTest")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC10cameraTest11AppDelegate")
...
SWIFT_CLASS("_TtC10cameraTest14ViewController")
...
- (IBAction)touchButton:(id _Nonnull)sender;
- (void)Tick;
